...
/// Root command for `discfree`, an agent-friendly CLI over the DiscFree scan engine.
///
...
public struct DiscFree: AsyncParsableCommand {
    public static let configuration = CommandConfiguration(
        commandName: "discfree",
        abstract: "Scan disk usage and reclaim developer caches on macOS.",
        discussion: """
        discfree writes primary data to stdout and diagnostics to stderr. Pass --json to any \
